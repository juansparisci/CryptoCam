...
namespace CryptoCamWebAPI.WebServices
{
    public interface IExchangeRates_API
    {
        ...
        public static readonly List<CryptoCurrency> CryptosAccepted = new List<CryptoCurrency> { new CryptoCurrency {Description = "BTC" }, new CryptoCurrency {Description = "ETH" }, new CryptoCurrency {Description = "SATS" }, new CryptoCurrency {Description = "LTC" }, new CryptoCurrency { Description = "DOGE" } };


        public abstract Task<List<ExchangeRate>> GetAllRates();
        public abstract Task<List<ExchangeRate>> GetAllRatesWithoutFiltering();
    }
}
