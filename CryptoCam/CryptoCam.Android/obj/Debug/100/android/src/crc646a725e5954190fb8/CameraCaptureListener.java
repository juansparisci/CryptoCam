...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("CryptoCam.Droid.CameraCaptureListener, CryptoCam.Android", CameraCaptureListener.class, __md_methods);
	}
	...
	public CameraCaptureListener ()
	{
		...
		if (getClass () == CameraCaptureListener.class)
			mono.android.TypeManager.Activate ("CryptoCam.Droid.CameraCaptureListener, CryptoCam.Android", "", this, new java.lang.Object[] {  });
	}
