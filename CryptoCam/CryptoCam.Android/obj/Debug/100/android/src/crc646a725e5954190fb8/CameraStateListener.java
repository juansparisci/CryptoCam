...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("CryptoCam.Droid.CameraStateListener, CryptoCam.Android", CameraStateListener.class, __md_methods);
	}
	...
	public CameraStateListener ()
	{
		...
		if (getClass () == CameraStateListener.class)
			mono.android.TypeManager.Activate ("CryptoCam.Droid.CameraStateListener, CryptoCam.Android", "", this, new java.lang.Object[] {  });
	}
